    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <%
                            ...
                            Commande c = css.getPanier();
                        LigneService ls = new LigneService();
                           ProduitService ps = new ProduitService();
                           for (LigneCommande l : ls.getByCommande(c)){
                            ...
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <a class="btn btn-sm btn-primary btn-minus" href="quantite?action=min&id=<%=p.getId()%>">
                                        <i class="fa fa-minus"></i>
                                        </a>
                                    </div>
                                        <input type="text" name="qte" class="form-control form-control-sm bg-secondary text-center" value="<%=l.getQuantite()%>" readonly>
                                    <div class="input-group-btn">
                                        <a class="btn btn-sm btn-primary btn-plus" href="quantite?action=plus&id=<%=p.getId()%>">
            ...
            <div class="col-lg-4">
                ...
                <form class="mb-5" action="GET" name="/checkoutServlet"> 
                <div class="card border-secondary mb-5">
                    ...
                    <!--<div class="card-body">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium"> Dh</h6>
                        </div>
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <a class="btn btn-block btn-primary my-3 py-3" href="checkoutServlet?somme=<%=somme%>">Proceed To Checkout</a>
                    </div>
                </div>
                    </form>
            </div>
